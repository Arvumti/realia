$(document).ready(function() {
    ...
    $('.btn.menu_responsivo').on('click', function() {
        $(this).toggleClass('opn');
    });
    $('.onepage .navbar .nav li a').on('click', function() {
        $('.navbar .navbar-collapse.in').collapse('hide');
        $('.btn.menu_responsivo').removeClass('opn');
    });
    ...
    $('.player').fitVids();
    /*-----------------------------------------------------------------------------------*/
    /*	icono sobre imagen hover
	/*-----------------------------------------------------------------------------------*/
    $('.icon-overlay a').prepend('<span class="icn-more"></span>');
    /*-----------------------------------------------------------------------------------*/
    /*	revolution sld
	/*-----------------------------------------------------------------------------------*/
    $('.slider_completo').revolution({
        delay: 9000,
        startwidth: 1170,
        startheight: 750,
        hideThumbs: 0,
    ...
    var instagramFeed = new Instafeed({
        ...
        after: function() {
            ...
            var $portfoliogrid = $('.img_grid .isotope');
    ...
    /*-----------------------------------------------------------------------------------*/
    var $gridviewcol3 = $('.grid_ver.col3 .isotope');
    $gridviewcol3.isotope({
        itemSelector: '.grid_ver_post',
    ...
    /*-----------------------------------------------------------------------------------*/
    var $gridviewcol2 = $('.grid_ver.col2 .isotope');
...
$(window).load(function() {
    $('#status').fadeOut();
    $('#cargar_web').delay(350).fadeOut('slow');
    $('#cargar_web .carga_texto').delay(0).fadeOut('slow');
    $('body').delay(350).css({
        'overflow': 'visible'
    });
});
